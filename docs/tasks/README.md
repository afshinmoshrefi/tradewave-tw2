...
Features, documentation and other substantive work follow [Shared Work Management](../WORK_MANAGEMENT.md). Use [the template](TEMPLATE.md); bugs have their [own register](../bugs/README.md).
...
| [TW-TASK-0009](TW-TASK-0009.md) | in-progress | Claude/ChatGPT script profiles verified on Dev (Astra High); server ChatGPT sign-in and scheduler cutover pending; production migration remains proposed |
