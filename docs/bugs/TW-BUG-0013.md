...
Follow-up data check after owner clarification: /home/flask/data/csv/US/LRCX.csv and csv_old/US/LRCX.csv on dev both have adjusted close 0.0943 at 1986-09-22 and 1986-11-20 (same adj_factor 0.0188562287542491). The older file is dated August 5, while the prebuilt opportunity file is dated August 1. Thus no demonstrated recent price revision explains the exact-zero discrepancy; the original August 1 generation input is still unverified. Current generator location requested from owner because the only found local notebook is a historical copy. No strict-positive long repair is authorized or appropriate under the clarified rule. Remaining next step: inspect current generator and its original generation inputs to determine why 10_9_PE2 is absent.
