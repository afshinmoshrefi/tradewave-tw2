// this version of textbox puts the onchange to be on the calling component.  I needed it for auto trading credit
// so that I can trigger lock if focus if any text is typed 1/10/2024
...
const TextBoxTrade = ({ tooltipContent, name, text, width, tbBlur, tbEnter, securityTypeList2, selectedSecurity, browserH, browserW, qparams, errorStatus }) => {
    ...
    return (
        ...
        <Tippy placement={ttp} content={
            ...
            <div>
                ...
                <input type="text" value={curText} onBlur={tbBlur} onChange={handleOnChange} onKeyPress={tbEnter} size={width} id={name} style={{ fontWeight: textFontWeight, fontSize: textboxFontSize, height: textHeight, paddingLeft: paddingText, textAlign: textAlign, border: '1px solid ' + tc.inputBorder, backgroundColor: tc.inputBg, color: tc.text }} />
            </div>
