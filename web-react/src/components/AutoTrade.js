...
const AutoTrade = (props) => {
    ...
    return (
        ...
        <div style={DashboardCover} onClick={() => { props.SetShowAutoTrade(false); }}>
            ...
            <div style={popupDialogStyle} onClick={(e) => { e.stopPropagation(); }}>
                ...
                <div style={{ width: '100%', height: '12%', backgroundColor: 'gray', display: 'flex' }}>
                    ...
                    <div className='div_basic' style={{ height: '100%', width: titleCenterDivWidth, backgroundColor: 'transparent' }}><span style={{ fontSize: title_text_size, color: 'whitesmoke' }}>Auto Trade</span></div>
                    <div className='div_basic' onClick={() => { props.SetShowAutoTrade(false); }} style={{ height: '100%', width: titleCloseDivWidth, backgroundColor: 'lightgray' }}><GrClose size={grclose_iconsize} /></div>
                </div>
                ...
                <div className='div_basic' style={{ width: '100%', height: '88%', backgroundColor: 'transparent', flexDirection: 'column' }}>
                    ...
                    <div className="add-gc-div-top-rows" style={{ backgroundColor: 'transparent', height: '10%', fontSize: fontSize, display: 'flex', alignItems: 'left' }}>
                        <div style={{ width: '50%', display: 'flex', justifyContent: 'left', alignItems: 'center' }}><span style={{ backgroundColor: 'black', color: 'white', marginLeft: '1vw' }}><TextBoxTime /></span>
                            {!(rdd.isMobile && !rdd.isTablet && browserH > browserW) &&
                                <span style={{ marginLeft: '1vw' }}>{local_timezone}</span>
                            }
                        </div>
                    </div>
