...
const TextBoxTime = ({ tooltipContent, name, text, width, tbBlur, tbEnter, securityTypeList2, selectedSecurity, browserH, browserW, qparams }) => {
    ...
    return (
        ...
        <Tippy placement={ttp} content={
            ...
            <div>
                ...
                <input type="time" value={curText} onBlur={tbBlur} onChange={handleOnChange} onKeyPress={tbEnter} size={width} id={name} style={{ fontWeight: textFontWeight, fontSize: textboxFontSize, height: textHeight, paddingLeft: paddingText, textAlign: textAlign, backgroundColor: tc.inputBg, color: tc.text, border: '1px solid ' + tc.inputBorder }} />
            </div>
