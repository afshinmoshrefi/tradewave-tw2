...
export const GETTING_STARTED_VIDEO_EMBED_URL = `https://www.youtube-nocookie.com/embed/${GETTING_STARTED_VIDEO_ID}?rel=0&autoplay=0&playsinline=1&cc_load_policy=0`;
...
export const GETTING_STARTED_VIDEO_SEEN_KEY = 'tw_getting_started_video_seen_v2';
