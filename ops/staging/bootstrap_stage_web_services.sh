...
add_header Content-Security-Policy "default-src 'self'; script-src 'self' 'unsafe-inline' https://www.googletagmanager.com https://js.stripe.com https://static.cloudflareinsights.com https://assets.mailerlite.com https://accounts.google.com; style-src 'self' 'unsafe-inline' https://assets.mailerlite.com; img-src 'self' data: blob: https:; font-src 'self' data: https:; connect-src 'self' https://*.google-analytics.com https://*.analytics.google.com https://www.googletagmanager.com https://api.stripe.com https://api.workos.com https://*.authkit.app https://cloudflareinsights.com https://static.cloudflareinsights.com https://assets.mailerlite.com https://accounts.google.com https://www.googleapis.com; frame-src 'self' https://js.stripe.com https://checkout.stripe.com https://*.authkit.app https://accounts.google.com; frame-ancestors 'self'; base-uri 'self'; form-action 'self' https://checkout.stripe.com https://api.workos.com https://*.authkit.app https://assets.mailerlite.com; object-src 'none'; upgrade-insecure-requests" always;
SNIP
