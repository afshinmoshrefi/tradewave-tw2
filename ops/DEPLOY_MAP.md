...
4. **regen_site** (`ops/regen_site.sh`, as flask, secrets sourced): regenerate ALL main-site pages with the correct host. Markets SKIP on a non-SMN box (by design). Fail-closed.
